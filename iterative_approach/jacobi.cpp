//program that calculates solution of linaer equation using jacobi's method
#include <iostream>
#include <vector>
#include <cmath>
using namespace std;

vector<float> jacobi(vector<vector<float>> coeffs) {
    int n = coeffs.size();
...
int main() {
    ...
    vector<float> result = jacobi(coeffs);
